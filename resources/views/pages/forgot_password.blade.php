    ...
    <div class="container">
        <div class="row justify-content-md-center mt-2">
            <div id="login-app" class="col-6">
                <div class="easyui-panel" title="Lupa Kata Sandi" style="width:100%;padding:30px 60px;" data-options="iconCls:'ms-Icon ms-Icon--UserEvent'">
                    <div class="row">
                    ...
                    <form id="login-form" method="post">
                        ...
                        <div class="mb-1" style="padding:5px 0;margin-left:149px;">
                            <p><em>Masukkan alamat Email anda, sistem akan mengirimkan tautan untuk mengatur ulang kata sandi Anda.</em></p>
                        </div>
                        <div style="padding:5px 0;margin-left:149px;">
                            <button type="button" class="easyui-linkbutton" tabindex="2" onclick="forgotPassword('{{ url('login') }}', '{{ csrf_token() }}')" style="width:164px">Kirim Tautan</button>
                            <a href="{{ url('/') }}" class="easyui-linkbutton" tabindex="3" style="width:100px">Kembali</a>
                        </div>
                    </form>
                    <br/>
                    <div class="row">
