...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - Statistik Rata-rata Nilai Ujian Kelas per RPP</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>Statistik Rata-rata Nilai Ujian Kelas per RPP</b></div>
      <br/>
      <br/>
      <div>
