<html>
    <head>
        <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - Statistik Kesantrian</title>
        <style type="text/css">
    ...
    <body style="">
        ...
        <div class="page">
            <div class="subpage">
                ...
                <div id="body">
                    <br/>
                    <div class="text-center" style="font-size:16px;"><b>Statisik Kesantrian</b></div>
                    <br/>
