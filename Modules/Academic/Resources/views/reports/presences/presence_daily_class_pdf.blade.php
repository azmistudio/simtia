...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - Data Presensi Harian Santri per Kelas</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>Data Presensi Harian Santri per Kelas</b></div>
      <br/>
      <br/>
      <div>
