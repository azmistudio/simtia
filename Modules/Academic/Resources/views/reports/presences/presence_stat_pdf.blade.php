...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - Data Statistik Presensi Harian Santri</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>Data Statistik Presensi Harian Santri</b></div>
      <br/>
      <br/>
      <div>
