        ...
        <div class="p-1">
            ...
            @csrf
                ...
                <div style="margin-left:100px;padding:5px 0">
                    <a href="javascript:void(0)" class="easyui-linkbutton small-btn flist-box" onclick="filterTeacher({fname: $('#fname-teacher').val(),flesson: $('#flesson-teacher').val()})">Cari</a>
            ...
            <table id="tb-teacher" class="easyui-datagrid" style="width:100%;height:{{ $GridHeight }}" data-options="singleSelect:true,method:'post',rownumbers:'true',pagination:'true',pageSize:50,pageList:[10,25,50,75,100]">
                <thead>
                    <tr>
                        ...
                        @endif
                        <th data-options="field:'employee',width:100,resizeable:true,sortable:true">Guru</th>
                        <th data-options="field:'lesson_id',width:80,resizeable:true,sortable:true">Pelajaran</th>
                        <th data-options="field:'status_id',width:80,resizeable:true,sortable:true">Status</th>
                    </tr>
                </thead>
            </table>
        </div>
