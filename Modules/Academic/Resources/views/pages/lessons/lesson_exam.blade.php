        ...
        <div class="p-1">
            ...
            @csrf
                ...
                <div style="margin-left:100px;padding:5px 0">
                    <a href="javascript:void(0)" class="easyui-linkbutton small-btn flist-box" onclick="filterLessonExam({fcode: $('#fcode-lesson-exam').val(),fname: $('#fname-lesson-exam').val()})">Cari</a>
