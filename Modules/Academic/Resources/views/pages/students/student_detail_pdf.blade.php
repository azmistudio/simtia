@inject('ReferenceTrait', 'Modules\Academic\Http\Controllers\StudentController')
@php
    ...
    <body style="">
        <div id="header">
            <table class="table no-border" style="width:100%;">
                <tbody>
                    <tr>
                        <th rowspan="2" style="width:100px;"><img src="file:///{{ $logo }}" height="80px" /></th>
        ...
        <div id="body">
            <br/>
            <div class="text-center" style="font-size:16px;"><b>Data Santri</b></div>
            <br/>
            <br/>
            <div>
                <table class="table no-border">
                    <tbody style="font-size:13px;font-weight: 700;">
                        <tr>
                            ...
                            <td>{{ $model->getProspectiveGroup->getAdmission->getDepartment->name }}</td>
                        </tr>
                        <tr>
                            <td>Tahun Ajaran</td>
                            <td style="width:30px;text-align:center;">:</td>
                            <td>{{ $model->getClass->getSchoolYear->school_year }}</td>
                        </tr>
                        <tr>
                            <td>Kelas</td>
                            <td style="width:30px;text-align:center;">:</td>
                            <td>{{ strtoupper($model->getClass->getGrade->grade) .' - '. ucwords($model->getClass->class) }}</td>
                        </tr>
                        <tr>
                            <td>Nomor Induk Santri (NIS)</td>
                            <td style="width:30px;text-align:center;">:</td>
                            <td>{{ $model->student_no }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table style="width:100%;">
                    <tbody style="font-size:13px;">
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getGender()[$model->gender] }}</td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getCitizen()[$model->citizen] }}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getReferences('hr_child_status')[$model->child_status] }}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getReferences('hr_economic')[$model->economic] }}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getReferences('hr_student_status')[$model->student_status] }}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getReferences('hr_tribe')[$model->tribe] }}</td>
                        </tr>
                        <tr>
                            <td></td>
                ...
                <table style="width:100%;">
                    <tbody style="font-size:13px;">
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td>{{ $ReferenceTrait->getReferences('hr_blood')[$model->blood] }}</td>
                        </tr>
                        <tr>
                            <td style="width:20px;"></td>
                ...
                <table style="width:100%;">
                    <tbody style="font-size:13px;">
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td style="width:35%;">{{ $model->father }}</td>
                            <td style="border-left: solid 1px #000;padding-left: 10px;">{{ $model->mother }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td style="width:35%;">{{ $ReferenceTrait->getReferences('hr_parent_status')[$model->father_status] }}</td>
                            <td style="border-left: solid 1px #000;padding-left: 10px;">{{ $ReferenceTrait->getReferences('hr_parent_status')[$model->mother_status] }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td style="width:150px;">Tempat, Tanggal Lahir</td>
                            <td style="width:20px;text-align:center;">:</td>
                            <td style="width:35%;">{{ $model->father_pob .', '. $model->father_dob->format('d/m/Y') }}</td>
                            <td style="border-left: solid 1px #000;padding-left: 10px;">{{ $model->mother_pob .', '. $model->mother_dob->format('d/m/Y') }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td style="width:35%;">{{ $ReferenceTrait->getReferences('hr_education')[$model->father_education] }}</td>
                            <td style="border-left: solid 1px #000;padding-left: 10px;">{{ $ReferenceTrait->getReferences('hr_education')[$model->mother_education] }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td style="width:20px;text-align:center;">:</td>
                            <td style="width:35%;">{{ $ReferenceTrait->getReferences('hr_job')[$model->father_job] }}</td>
                            <td style="border-left: solid 1px #000;padding-left: 10px;">{{ $ReferenceTrait->getReferences('hr_job')[$model->mother_job] }}</td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tbody style="font-size:13px;">
                            ...
                            <tr>
                                ...
                                <td style="">
                                    ...
                                    {{ ucfirst($col->values) }}
                                    @else
                                    {{ ucfirst($col->getColumnOption->name) }}
                                    @endif
                                </td>
                            </tr>
                            @php
