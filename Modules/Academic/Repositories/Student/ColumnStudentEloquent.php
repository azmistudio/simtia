...
class ColumnStudentEloquent implements ColumnStudentRepository
{
	...
	public function destroy($id, $subject)
	{
		...
		return ColumnStudent::where('student_id', $id)->delete();
	}
	...
	private function logActivity(Request $request, $model_id, $subject, $action) 
	{
		if ($action == 'Tambah')
		{
			...
			$query = ColumnStudent::where('student_id', $model_id)->first();
			$before = array(
