...
<div class="container-fluid mt-1 mb-1">
	<div class="row">
		<div class="col-8">
			<h6><b>Perubahan Data Jurnal Umum</b></h6>
						...
						<td>
							<table class="table table-bordered table-sm mb-0" width="100%">
								...
								<tr>
									...
									<td width="25%" class="text-right">Rp{{ number_format($sub->debit,2) }}</td>
									<td width="25%" class="text-right">Rp{{ number_format($sub->credit,2) }}</td>
								</tr>
								@endif
								@endforeach
							</table>
