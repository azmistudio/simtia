...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - PERUBAHAN DATA IURAN SUKARELA SANTRI</title>
  ...
  <body>
    ...
    <div id="body">
      ...
      <br/>
      <br/>
      <div class="text-center" style="font-size:16px;"><b>PERUBAHAN DATA IURAN SUKARELA SANTRI</b></div>
      <br/>
      <br/>
