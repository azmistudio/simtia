...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - PERUBAHAN DATA PENGELUARAN</title>
  ...
  <body>
    ...
    <div id="body">
      ...
      <br/>
      <br/>
      <div class="text-center" style="font-size:16px;"><b>PERUBAHAN DATA PENGELUARAN</b></div>
      <br/>
      <br/>
