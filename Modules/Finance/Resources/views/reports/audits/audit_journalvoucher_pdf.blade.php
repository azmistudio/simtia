...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - PERUBAHAN DATA JURNAL UMUM</title>
  ...
  <body>
    ...
    <div id="body">
      ...
      <br/>
      <br/>
      <div class="text-center" style="font-size:16px;"><b>PERUBAHAN DATA JURNAL UMUM</b></div>
      <br/>
      <br/>
      ...
      <table width="100%">
        <thead>
          <tr>
            ...
            <th class="text-center">Detail Jurnal</th>
            ...
            <td>
              <table class="table table-bordered table-sm mb-0" width="100%">
                ...
                <tr>
                  ...
                  <td class="text-right" width="25%">Rp{{ number_format($sub->debit,2) }}</td>
                  <td class="text-right" width="25%">Rp{{ number_format($sub->credit,2) }}</td>
                </tr>
                @endif
                @endforeach
              </table>
