...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - LAPORAN TABUNGAN SANTRI</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>LAPORAN TABUNGAN SANTRI</b></div>
      <br/>
      <br/>
      <div>
