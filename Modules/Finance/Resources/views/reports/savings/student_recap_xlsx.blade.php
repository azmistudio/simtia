  ...
  <body>
    <table class="no-border">
      <tbody>
        ...
        <tr><td colspan="5" align="center" class="title"><b>LAPORAN REKAPITULASI TABUNGAN SANTRI</b></td></tr>
        <tr><td colspan="5" align="center" class="subtitle"><b>DEPARTEMEN {{ $payloads->department }}</b></td></tr>
      </tbody>
    </table>
    <br/>
    <table class="no-border">
