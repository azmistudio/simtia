...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - LAPORAN REKAPITULASI TABUNGAN SANTRI</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>LAPORAN REKAPITULASI TABUNGAN SANTRI</b></div>
      <br/>
      <br/>
      <div>
        ...
        <div>
          <table border="1" style="width:100%;border-collapse:collapse">
            ...
            <tbody>
              ...
              @php
                $total_deposit += $saving->total_debit;
                $total_withdraw += $saving->total_credit;
              @endphp
              <tr height="25">
                ...
                <td class="text-right">Rp{{ number_format($saving->total_debit - $saving->total_credit,2) }}&nbsp;</td>
              </tr>
              @endforeach
            </tbody>
            <tfoot>
