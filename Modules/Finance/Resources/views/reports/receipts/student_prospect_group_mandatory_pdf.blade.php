...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - LAPORAN PEMBAYARAN PER KELOMPOK CALON SANTRI</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>LAPORAN PEMBAYARAN PER KELOMPOK CALON SANTRI - {{ $requests->payment }}</b></div>
      <br/>
      <br/>
      <div>
        ...
        <table class="table" style="width:100%;">
          <thead>
            <tr>
              ...
              <th class="text-center">Total<br/>Besar Pembayaran</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $pay->student }}</td>
              @php $receipts = $receiptMajorEloquent->listPaymentProspectGroup($requests->department_id, $pay->prospect_student_id, $requests->status); @endphp
