...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - LAPORAN PEMBAYARAN SUKARELA PER KELOMPOK CALON SANTRI</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>LAPORAN SUKARELA PER KELOMPOK CALON SANTRI - {{ $requests->payment }}</b></div>
      <br/>
      <br/>
      <div>
        ...
        <table class="table" style="width:100%;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $pay->student }}</td>
              @php $receipts = $receiptVoluntaryEloquent->listPaymentProspectGroup($requests->department_id, $requests->prospect_group_id, $pay->prospect_student_id); @endphp
