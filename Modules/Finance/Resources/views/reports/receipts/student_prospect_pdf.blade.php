...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - LAPORAN PEMBAYARAN PER CALON SANTRI</title>
  ...
  <body>
    ...
    <div id="body">
      <br/>
      <div class="text-center" style="font-size:16px;"><b>LAPORAN PEMBAYARAN PER CALON SANTRI</b></div>
      <br/>
      <br/>
      <div>
        <table class="table no-border" style="font-size: 13px;font-weight:700">
          <tbody>
            ...
            <tr>
              <td style="width:15%;">Proses Penerimaan</td>
              <td style="width:1%;text-align:center;">:</td>
            ...
            <tr>
              ...
              <td style="width:1%;text-align:center;">:</td>
              <td>{{ $requests->registration_no .' - '. $requests->student }}</td>
            </tr>
          </tbody>
        </table>
        <br/>
            ...
            <tr>
              <td width="50%" align="left" valign="top">
                <table border="1" style="width:100%;border-collapse:collapse" cellpadding="5">
                  <tbody>
                    <tr>
                      <td colspan="2" bgcolor="#87C7F4" style="font-size:14px;"><b>Iuran Wajib Calon Santri</b></td>
                    </tr>
                    <tr>
              ...
              <td width="50%" align="left" valign="top">
                <table border="1" style="width:100%;border-collapse:collapse" cellpadding="5">
                  <tbody>
                    <tr>
                      <td colspan="2" bgcolor="#87C7F4" style="font-size:14px;"><b>Iuran Sukarela Calon Santri</b></td>
                    </tr>
                      <tr>
                        <td bgcolor="#E6F5FF">Total Semua Pembayaran</td>
