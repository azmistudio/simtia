  ...
  <body>
    <table class="no-border">
      <tbody>
        ...
        <tr><td colspan="4" align="center" class="title"><b>LAPORAN PEMBAYARAN PER CALON SANTRI</b></td></tr>
        <tr><td colspan="4" align="center" class="subtitle"><b>DEPARTEMEN {{ $payloads->department }} - PROSES {{ $payloads->admission }}</b></td></tr>
      </tbody>
    </table>
    <br/>
    <table class="no-border">
      <tbody>
        <tr>
          <td>Kelompok</td>
          <td>: <b>{{ $payloads->prospect_group }}</b></td>
        </tr>
        <tr>
          <td>Santri</td>
          <td>: <b>{{ $payloads->registration_no .' - '. $payloads->student }}</b></td>
        </tr>
        <tr>
          <td>Tanggal</td>
