...
<html>
  <head>
    <title>{{ config('app.name') .' '. strtoupper(Session::get('institute')) }} - LAPORAN JURNAL PENGELUARAN</title>
  ...
  <body>
    ...
    <div id="body">
      ...
      <br/>
      <br/>
      <div class="text-center" style="font-size:16px;"><b>LAPORAN JURNAL PENGELUARAN</b></div>
      <br/>
      <br/>
