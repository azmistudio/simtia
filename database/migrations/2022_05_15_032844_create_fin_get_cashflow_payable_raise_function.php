...
return new class extends Migration
{
    ...
    public function up()
    {
        $procedure = "  CREATE OR REPLACE FUNCTION finance.fn_get_cashflow_payable_raise (
                        ...
                        AS $$
                            ...
                            BEGIN
                                ...
                                WHERE c.category = 'HARTA' AND a.debit > 0 AND a.journal_id IN (
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS finance.fn_get_cashflow_payable_raise"); 
    }
};
