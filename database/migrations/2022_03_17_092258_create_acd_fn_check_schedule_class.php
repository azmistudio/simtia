...
return new class extends Migration
{
    ...
    public function up()
    {
        $procedure = "  CREATE OR REPLACE FUNCTION academic.fn_check_schedule_class (
                            IN p_infos TEXT,
                            IN p_day SMALLINT,
                            IN p_class SMALLINT,
                            IN p_time TEXT
                        ...
                        AS $$
                            ...
                            BEGIN
                                ...
                                RETURN QUERY EXECUTE
                                    ...
                                    AND academic.lesson_schedules.class_id = ' || p_class || '
                                    AND ' || p_time;
                            END;
                        $$;";
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS academic.fn_check_schedule_class");   
    }
};
