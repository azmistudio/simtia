...
return new class extends Migration
{
    ...
    public function up()
    {
        $procedure = "  CREATE OR REPLACE FUNCTION finance.fn_get_trx_debit_account_parent (
                        ...
                        AS $$
                            DECLARE 
                                v_value NUMERIC;
                            BEGIN
                                SELECT COALESCE(SUM(a.debit) - SUM(a.credit),0) FROM finance.journal_details a
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS finance.fn_get_trx_debit_account_parent");   
    }
};
