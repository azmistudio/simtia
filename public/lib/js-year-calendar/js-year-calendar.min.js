! function(e, t) {
    ...
    var s = function() {
        function D(e) {
            ...
            this.element.classList.add("year-calendar"), this._initializeEvents(t), this._initializeOptions(t), this.setYear(this.options.startYear)
        }
        var e, t, n;
        return e = D, (t = [{
            ...
            value: function() {
                ...
                e.classList.add("year-calendar-header");
            ...
            value: function() {
                ...
                }), this.element.querySelector(".year-calendar-header .prev").addEventListener("click", function(e) {
                ...
                }), this.element.querySelector(".year-calendar-header .next").addEventListener("click", function(e) {
                    if (!e.currentTarget.classList.contains("disabled")) {
                        var t = s.element.querySelector(".months-container");
                        t.style.transition = "margin-left 0.1s", t.style.marginLeft = "-100%", setTimeout(function() {
                            t.style.visibility = "hidden", t.style.transition = "", t.style.marginLeft = "0", setTimeout(function() {
    ...
    i(e.default = s, "locales", {
        ...
        id: {
            ...
            daysShort: ["Aha", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"],
            ...
            monthsShort: ["Jan", "Peb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nop", "Des"],
            weekShort: "M",
            weekStart: 0
        }
        ...
        document.querySelectorAll('[data-provide="year-calendar"]').forEach(function(e) {
            return new s(e)
        })
    }))
});